...
def get_chat_prompt():
    ...
    rag_instruction = "Use the following pieces of context to answer the human's questions. If you don't know the answer, just say that you don't know, don't try to make up an answer.\n\nContext: {context}"
